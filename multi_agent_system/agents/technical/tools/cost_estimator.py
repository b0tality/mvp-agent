...
class CostEstimatorToolOutput(BaseModel):
    """Output schema"""
    estimated_hours: int = Field(default=0, description="Estimated hours")
    team_size: int = Field(default=0, description="Team size")
    timeline: str = Field(default="unknown", description="Timeline")
...
class CostEstimatorTool(BaseTool):
    ...
    description: str = "Perform Estimate project cost"
    ...
    def _run(self, requirements: Dict[str, Any], tech_stack: Dict[str, Any], run_manager=None) -> Dict[str, Any]:
        ...
        structured_llm = self.llm.with_structured_output(CostEstimatorToolOutput)
        ...
        try:
            ...
            try:
                ...
                return {"estimated_hours": 0, "team_size": 0, "timeline": "unknown"}
