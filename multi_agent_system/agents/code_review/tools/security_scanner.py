...
class SecurityScannerToolOutput(BaseModel):
    """Output schema"""
    vulnerabilities: List[Dict[str, str]] = Field(default_factory=list, description="Vulnerabilities")
...
class SecurityScannerTool(BaseTool):
    ...
    description: str = "Perform Scan security vulnerabilities"
    ...
    def _run(self, code_file: Dict[str, Any], run_manager=None) -> Dict[str, Any]:
        ...
        structured_llm = self.llm.with_structured_output(SecurityScannerToolOutput)
