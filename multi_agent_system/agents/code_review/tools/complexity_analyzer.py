...
class ComplexityAnalyzerToolOutput(BaseModel):
    """Output schema"""
...
class ComplexityAnalyzerTool(BaseTool):
    ...
    description: str = "Perform Analyze code complexity"
    ...
    def _run(self, code_file: Dict[str, Any], run_manager=None) -> Dict[str, Any]:
        ...
        structured_llm = self.llm.with_structured_output(ComplexityAnalyzerToolOutput)
        ...
        try:
            ...
            try:
                ...
                return {"cyclomatic_complexity": 0, "cognitive_complexity": 0, "suggestions": []}
